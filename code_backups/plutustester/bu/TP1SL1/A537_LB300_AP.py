...
backtest: Backtest = Backtest({
    "id": "A537_LB300_AP",
    "description": "The purpose of this backtest is to find out how different arima prediction quantity can alter the performance.",
    "start": '1/10/2021',
    "end": '22/04/2022',
    "take_profit": 1,
    "stop_loss": 1,
    ...
    "models": [
        ...
        Model({
            ...
            "single_models": [{
                'lookback': 300,
                'arima': { 'predictions': 15, 'p': 5, 'd': 3, 'q': 7 },
                'interpreter': { 'long': 0.05, 'short': 0.05 }
            }]
        }),
        ...
        Model({
            ...
            "single_models": [{
                'lookback': 300,
                'arima': { 'predictions': 20, 'p': 5, 'd': 3, 'q': 7 },
                'interpreter': { 'long': 0.05, 'short': 0.05 }
            }]
        }),
    ]
