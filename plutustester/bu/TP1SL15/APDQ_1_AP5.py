...
backtest: Backtest = Backtest({
    ...
    "models": [
        ...
        Model({
            ...
            "single_models": [{
                'lookback': 300,
                'arima': { 'predictions': 5, 'p': 2, 'd': 1, 'q': 2 },
        ...
        Model({
            ...
            "single_models": [{
                'lookback': 300,
                'arima': { 'predictions': 5, 'p': 3, 'd': 2, 'q': 2 },
                'interpreter': { 'long': 0.05, 'short': 0.05 }
            }]
        }),
        ...
        Model({
            ...
            "single_models": [{
                'lookback': 300,
                'arima': { 'predictions': 5, 'p': 3, 'd': 2, 'q': 3 },
                'interpreter': { 'long': 0.05, 'short': 0.05 }
            }]
        }),
        ...
        Model({
            ...
            "single_models": [{
                'lookback': 300,
                'arima': { 'predictions': 5, 'p': 3, 'd': 2, 'q': 4 },
                'interpreter': { 'long': 0.05, 'short': 0.05 }
            }]
        }),
        ...
        Model({
            ...
            "single_models": [{
                'lookback': 300,
                'arima': { 'predictions': 5, 'p': 3, 'd': 2, 'q': 5 },
                'interpreter': { 'long': 0.05, 'short': 0.05 }
            }]
        }),
        ...
        Model({
            ...
            "single_models": [{
                'lookback': 300,
                'arima': { 'predictions': 5, 'p': 4, 'd': 2, 'q': 5 },
                'interpreter': { 'long': 0.05, 'short': 0.05 }
            }]
        }),
    ]
