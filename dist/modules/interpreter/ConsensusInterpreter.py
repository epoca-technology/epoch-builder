...
from modules.types import IConsensusInterpreterConfig, IPredictionResult, IPredictionDescription
...
class ConsensusInterpreter(InterpreterInterface):
    ...
    def interpret(self, pred_results: List[IPredictionResult]) -> Tuple[IPredictionResult, IPredictionDescription]:
        ...
        Args:
            pred_results: List[IPredictionResult]
