...
# Class
class RegressionModel(RegressionModelInterface):
    ...
    def __init__(self, config: IModel, regression: Union[KerasRegression, XGBRegression], enable_cache: bool = False):
        ...
        Args:
            ...
            regression: Union[KerasRegression, XGBRegression]
                The regression that will be used to generate predictions.
            enable_cache: bool
        ...
        self.regression: Union[KerasRegression, XGBRegression] = regression
    ...
    def get_model(self) -> IModel:
        ...
        Returns:
            IModel
        """
        raise NotImplementedError("RegressionModel.get_model has not been properly implemented.")
    ...
    def is_config(model: IModel) -> bool:
        """Verifies if a model is matches the correct instance.
        ...
        Returns:
            bool
        """
        raise NotImplementedError("RegressionModel.is_config has not been properly implemented.")