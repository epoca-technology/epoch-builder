...
class ITrainingDataConfig(TypedDict):
    ...
    # The list of SingleModel configs that will be used
    single_models: List[IModel]
...
class ITrainingDataActivePosition(TypedDict):
    ...
    row: Dict           # Model's features which will be completed with labels once the position closes
...
# single models.
class ITrainingDataPriceActionAnalysis(TypedDict):
    up: float
    down: float
class ITrainingDataPredictionAnalysis(TypedDict):
    long: float
    short: float
    neutral: float
...
# The receipt that contains information related to the generated Training Data.
class ITrainingDataReceipt(ITrainingDataConfig):
    # Identifier, generated based on the single_models
    id: str
    ...
    # Price Action Analysis - The up and down percentage proportions
    price_action_analysis: ITrainingDataPriceActionAnalysis

    # Prediction Analysis 
    # Position type percentage proportions for each single model in this format:
    # {[modelID: str]: ITrainingDataPredictionAnalysis}
    predictions_analysis: Dict
