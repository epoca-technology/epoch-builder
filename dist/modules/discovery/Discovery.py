...
class Discovery:
    ...
    def build(self) -> IDiscovery:
        ...
        # Build the minified points history
        final_points_hist: List[float] = []
        for i in arange(0.1, 1.1, 0.1):
            if i == 1:
                final_points_hist.append(round(self.points_hist[-1], 2))
            else:
                final_points_hist.append(round(self.points_hist[int(len(self.points_hist) * i)], 2))
        ...
        return {
            ...
            "points_hist": final_points_hist,
            "points": final_points_hist[-1],
