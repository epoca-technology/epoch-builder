...
KR_CNN_DO_S2: List[IKerasModelConfig] = [
...
# 3 activations:    Conv1D_1, Dense_1, Dense_2
# 2 dropout_rates:  Dropout_1, Dropout_2
KR_CNN_MP_DO_S2: List[IKerasModelConfig] = [
...
KR_CNN_DO_S3: List[IKerasModelConfig] = [
...
# 4 activations:    Conv1D_1, Dense_1, Dense_2, Dense_3
# 3 dropout_rates:  Dropout_1, Dropout_2, Dropout_3
KR_CNN_MP_DO_S3: List[IKerasModelConfig] = [
...
KR_CNN_DO_S4: List[IKerasModelConfig] = [
...
# 5 activations:    Conv1D_1, Dense_1, Dense_2, Dense_3, Dense_4
# 4 dropout_rates:  Dropout_1, Dropout_2, Dropout_3, Dropout_4
KR_CNN_MP_DO_S4: List[IKerasModelConfig] = [
...
KR_CNN_DO_S5: List[IKerasModelConfig] = [
...
# 6 activations:    Conv1D_1, Dense_1, Dense_2, Dense_3, Dense_4, Dense_5
# 5 dropout_rates:  Dropout_1, Dropout_2, Dropout_3, Dropout_4, Dropout_5
KR_CNN_MP_DO_S5: List[IKerasModelConfig] = [
...
CNN: IKerasHyperparamsNetworkVariations = {
    "KR_CNN_S2": KR_CNN_S2,
    "KR_CNN_DO_S2": KR_CNN_DO_S2,
    "KR_CNN_MP_S2": KR_CNN_MP_S2,
    "KR_CNN_MP_DO_S2": KR_CNN_MP_DO_S2,
    "KR_CNN_S3": KR_CNN_S3,
    "KR_CNN_DO_S3": KR_CNN_DO_S3,
    "KR_CNN_MP_S3": KR_CNN_MP_S3,
    "KR_CNN_MP_DO_S3": KR_CNN_MP_DO_S3,
    "KR_CNN_S4": KR_CNN_S4,
    "KR_CNN_DO_S4": KR_CNN_DO_S4,
    "KR_CNN_MP_S4": KR_CNN_MP_S4,
    "KR_CNN_MP_DO_S4": KR_CNN_MP_DO_S4,
    "KR_CNN_S5": KR_CNN_S5,
    "KR_CNN_DO_S5": KR_CNN_DO_S5,
    "KR_CNN_MP_S5": KR_CNN_MP_S5,
    "KR_CNN_MP_DO_S5": KR_CNN_MP_DO_S5
}