...
KR_CLSTM_DO_S2: List[IKerasModelConfig] = [
...
# 1 activations:    Conv1D_1
# 2 dropout_rates:  Dropout_1, Dropout_2
KR_CLSTM_MP_DO_S2: List[IKerasModelConfig] = [
...
KR_CLSTM_DO_S3: List[IKerasModelConfig] = [
...
# 1 activations:    Conv1D_1
# 3 dropout_rates:  Dropout_1, Dropout_2, Dropout_3
KR_CLSTM_MP_DO_S3: List[IKerasModelConfig] = [
...
KR_CLSTM_DO_S4: List[IKerasModelConfig] = [
...
# 1 activations:    Conv1D_1
# 4 dropout_rates:  Dropout_1, Dropout_2, Dropout_3, Dropout_4
KR_CLSTM_MP_DO_S4: List[IKerasModelConfig] = [
...
KR_CLSTM_DO_S5: List[IKerasModelConfig] = [
...
# 1 activations:    Conv1D_1
# 5 dropout_rates:  Dropout_1, Dropout_2, Dropout_3, Dropout_4, Dropout_5
KR_CLSTM_MP_DO_S5: List[IKerasModelConfig] = [
...
CLSTM: IKerasHyperparamsNetworkVariations = {
    ...
    "KR_CLSTM_DO_S2": KR_CLSTM_DO_S2,
    "KR_CLSTM_MP_S2": KR_CLSTM_MP_S2,
    "KR_CLSTM_MP_DO_S2": KR_CLSTM_MP_DO_S2,
    "KR_CLSTM_S3": KR_CLSTM_S3,
    "KR_CLSTM_DO_S3": KR_CLSTM_DO_S3,
    "KR_CLSTM_MP_S3": KR_CLSTM_MP_S3,
    "KR_CLSTM_MP_DO_S3": KR_CLSTM_MP_DO_S3,
    "KR_CLSTM_S4": KR_CLSTM_S4,
    "KR_CLSTM_DO_S4": KR_CLSTM_DO_S4,
    "KR_CLSTM_MP_S4": KR_CLSTM_MP_S4,
    "KR_CLSTM_MP_DO_S4": KR_CLSTM_MP_DO_S4,
    "KR_CLSTM_S5": KR_CLSTM_S5,
    "KR_CLSTM_DO_S5": KR_CLSTM_DO_S5,
    "KR_CLSTM_MP_S5": KR_CLSTM_MP_S5,
    "KR_CLSTM_MP_DO_S5": KR_CLSTM_MP_DO_S5
}