...
# 2 units:          LSTM_1, LSTM_2
# 1 activations:    Conv1D_1
KR_CLSTM_S2_MP: List[IKerasModelConfig] = [
...
# 3 units:          LSTM_1, LSTM_2, LSTM_3
# 1 activations:    Conv1D_1
KR_CLSTM_S3_MP: List[IKerasModelConfig] = [
...
# 4 units:          LSTM_1, LSTM_2, LSTM_3, LSTM_4
# 1 activations:    Conv1D_1
KR_CLSTM_S4_MP: List[IKerasModelConfig] = [
...
# 5 units:          LSTM_1, LSTM_2, LSTM_3, LSTM_4, LSTM_5
# 1 activations:    Conv1D_1
KR_CLSTM_S5_MP: List[IKerasModelConfig] = [
...
CLSTM: IKerasHyperparamsNetworkVariations = {
    ...
    "KR_CLSTM_S2_MP": KR_CLSTM_S2_MP,
    "KR_CLSTM_S3": KR_CLSTM_S3,
    "KR_CLSTM_S3_MP": KR_CLSTM_S3_MP,
    "KR_CLSTM_S4": KR_CLSTM_S4,
    "KR_CLSTM_S4_MP": KR_CLSTM_S4_MP,
    "KR_CLSTM_S5": KR_CLSTM_S5,
    "KR_CLSTM_S5_MP": KR_CLSTM_S5_MP
}