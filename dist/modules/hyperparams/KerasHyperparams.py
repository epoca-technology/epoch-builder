...
class KerasHyperparams:
    ...
    Instance Properties:
        ...
        output_name: str
            The name of the output. This can be the name of an epoch or an experiment.
        output_path: str
    ...
    def __init__(
        ...
        self.output_path: str = f"{self.base_path}/{self.output_name}"
    ...
    def _generate_model_config(
        ...
        description: str = f"Generated by Hyperparams ({self.output_name})."
