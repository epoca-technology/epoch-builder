...
# Training Result
# Any model that does not complete at least 50% of its training is considered to
# have failed.
def training_passed(history: IKerasModelTrainingHistory, epochs: int) -> bool:
    """Verifies if a model completed at least 50% of its training.
    ...
    Returns bool
    """
    return Utils.get_percentage_out_of_total(len(history["loss"]), epochs) >= 50