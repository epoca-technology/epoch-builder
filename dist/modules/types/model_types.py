from typing import TypedDict, List, Union, Dict, Literal, Any
...
class IPredictionMetaData(TypedDict):
    ...
    # List of predictions generated by a Regression as well as the price when
    # it was generated.
...
class IXGBRegressionModelConfig(IRegressionModelConfig):
    regression: Union[IXGBRegressionConfig, None] #TODO
...
class IXGBClassificationModelConfig(IClassificationModelConfig):
    classification: Union[IXGBClassificationConfig, None] #@TODO
