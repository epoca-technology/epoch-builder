...
# single models.
class ITrainingDataPriceActionInsight(TypedDict):
    up: float
    down: float
...
class ITrainingDataReceipt(ITrainingDataConfig):
    ...
    # Price Action Insight - The up and down percentage proportions
    price_action_insight: ITrainingDataPriceActionInsight

    # Prediction Insight 
    # Position type percentage proportions for each single model in this format:
    # {[modelID: str]: ITrainingDataPredictionInsight}
    predictions_insight: Dict
