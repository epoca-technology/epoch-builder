...
def C_CNN_S1_MP_DO(m: IKerasModelConfig) -> Sequential:
    validate(m, "C_CNN_S1_MP_DO", filters=1, kernel_sizes=1, pool_sizes=1, dropout_rates=1, activations=1)
    return Sequential([
        Input(shape=(m["features_num"],1), name="Input_1"),
        Reshape((m["features_num"],1,), name="Reshape_1"),
        Conv1D(m["filters"][0], kernel_size=(m["kernel_sizes"][0],), activation=m["activations"][0], name="Conv1D_1"),
...
def C_CNN_S2_DO(m: IKerasModelConfig) -> Sequential:
    validate(m, "C_CNN_S2_DO", filters=2, kernel_sizes=2, dropout_rates=2, activations=2)
    return Sequential([
        Input(shape=(m["features_num"],1), name="Input_1"),
        Reshape((m["features_num"],1,), name="Reshape_1"),
        Conv1D(m["filters"][0], kernel_size=(m["kernel_sizes"][0],), activation=m["activations"][0], name="Conv1D_1"),
...
def C_CNN_S2_MP_DO(m: IKerasModelConfig) -> Sequential:
    validate(m, "C_CNN_S2_MP_DO", filters=2, kernel_sizes=2, pool_sizes=2, dropout_rates=2, activations=2)
    return Sequential([
        Input(shape=(m["features_num"],1), name="Input_1"),
        Reshape((m["features_num"],1,), name="Reshape_1"),
        Conv1D(m["filters"][0], kernel_size=(m["kernel_sizes"][0],), activation=m["activations"][0], name="Conv1D_1"),
...
def C_CNN_S3_DO(m: IKerasModelConfig) -> Sequential:
    validate(m, "C_CNN_S3_DO", filters=3, kernel_sizes=3, dropout_rates=3, activations=3)
    return Sequential([
        Input(shape=(m["features_num"],1), name="Input_1"),
        Reshape((m["features_num"],1,), name="Reshape_1"),
        Conv1D(m["filters"][0], kernel_size=(m["kernel_sizes"][0],), activation=m["activations"][0], name="Conv1D_1"),
...
def C_CNN_S3_MP_DO(m: IKerasModelConfig) -> Sequential:
    validate(m, "C_CNN_S3_MP_DO", filters=3, kernel_sizes=3, pool_sizes=3, dropout_rates=3, activations=3)
    return Sequential([
        Input(shape=(m["features_num"],1), name="Input_1"),
        Reshape((m["features_num"],1,), name="Reshape_1"),
        Conv1D(m["filters"][0], kernel_size=(m["kernel_sizes"][0],), activation=m["activations"][0], name="Conv1D_1"),
...
def C_CNN_S4_DO(m: IKerasModelConfig) -> Sequential:
    validate(m, "C_CNN_S4_DO", filters=4, kernel_sizes=4, dropout_rates=4, activations=4)
    return Sequential([
        Input(shape=(m["features_num"],1), name="Input_1"),
        Reshape((m["features_num"],1,), name="Reshape_1"),
        Conv1D(m["filters"][0], kernel_size=(m["kernel_sizes"][0],), activation=m["activations"][0], name="Conv1D_1"),
...
def C_CNN_S4_MP_DO(m: IKerasModelConfig) -> Sequential:
    validate(m, "C_CNN_S4_MP_DO", filters=4, kernel_sizes=4, pool_sizes=4, dropout_rates=4, activations=4)
    return Sequential([
        Input(shape=(m["features_num"],1), name="Input_1"),
        Reshape((m["features_num"],1,), name="Reshape_1"),
        Conv1D(m["filters"][0], kernel_size=(m["kernel_sizes"][0],), activation=m["activations"][0], name="Conv1D_1"),
...
def C_CLSTM_S1_DO(m: IKerasModelConfig) -> Sequential:
    validate(m, "C_CLSTM_S1_DO", filters=1, kernel_sizes=1, units=1, dropout_rates=1, activations=1)
    return Sequential([
        Input(shape=(m["features_num"],1), name="Input_1"),
        Reshape((m["features_num"],1,), name="Reshape_1"),
        Conv1D(m["filters"][0], kernel_size=(m["kernel_sizes"][0],), activation=m["activations"][0], name="Conv1D_1"),
...
def C_CLSTM_S1_MP_DO(m: IKerasModelConfig) -> Sequential:
    validate(m, "C_CLSTM_S1_MP_DO", filters=1, kernel_sizes=1, pool_sizes=1, units=1, dropout_rates=1, activations=1)
    return Sequential([
        Input(shape=(m["features_num"],1), name="Input_1"),
        Reshape((m["features_num"],1,), name="Reshape_1"),
        Conv1D(m["filters"][0], kernel_size=(m["kernel_sizes"][0],), activation=m["activations"][0], name="Conv1D_1"),
...
def C_CLSTM_S2_DO(m: IKerasModelConfig) -> Sequential:
    validate(m, "C_CLSTM_S2_DO", filters=1, kernel_sizes=1, units=2, dropout_rates=2, activations=1)
    return Sequential([
        Input(shape=(m["features_num"],1), name="Input_1"),
        Reshape((m["features_num"],1,), name="Reshape_1"),
        Conv1D(m["filters"][0], kernel_size=(m["kernel_sizes"][0],), activation=m["activations"][0], name="Conv1D_1"),
...
def C_CLSTM_S2_MP_DO(m: IKerasModelConfig) -> Sequential:
    validate(m, "C_CLSTM_S2_MP_DO", filters=1, kernel_sizes=1, pool_sizes=1, units=2, dropout_rates=2, activations=1)
    return Sequential([
        Input(shape=(m["features_num"],1), name="Input_1"),
        Reshape((m["features_num"],1,), name="Reshape_1"),
        Conv1D(m["filters"][0], kernel_size=(m["kernel_sizes"][0],), activation=m["activations"][0], name="Conv1D_1"),
...
def C_CLSTM_S3_DO(m: IKerasModelConfig) -> Sequential:
    validate(m, "C_CLSTM_S3_DO", filters=1, kernel_sizes=1, units=3, dropout_rates=3, activations=1)
    return Sequential([
        Input(shape=(m["features_num"],1), name="Input_1"),
        Reshape((m["features_num"],1,), name="Reshape_1"),
        Conv1D(m["filters"][0], kernel_size=(m["kernel_sizes"][0],), activation=m["activations"][0], name="Conv1D_1"),
...
def C_CLSTM_S3_MP_DO(m: IKerasModelConfig) -> Sequential:
    validate(m, "C_CLSTM_S3_MP_DO", filters=1, kernel_sizes=1, pool_sizes=1, units=3, dropout_rates=3, activations=1)
    return Sequential([
        Input(shape=(m["features_num"],1), name="Input_1"),
        Reshape((m["features_num"],1,), name="Reshape_1"),
        Conv1D(m["filters"][0], kernel_size=(m["kernel_sizes"][0],), activation=m["activations"][0], name="Conv1D_1"),
...
def C_CLSTM_S4_DO(m: IKerasModelConfig) -> Sequential:
    validate(m, "C_CLSTM_S4_DO", filters=1, kernel_sizes=1, units=4, dropout_rates=4, activations=1)
    return Sequential([
        Input(shape=(m["features_num"],1), name="Input_1"),
        Reshape((m["features_num"],1,), name="Reshape_1"),
        Conv1D(m["filters"][0], kernel_size=(m["kernel_sizes"][0],), activation=m["activations"][0], name="Conv1D_1"),
...
def C_CLSTM_S4_MP_DO(m: IKerasModelConfig) -> Sequential:
    validate(m, "C_CLSTM_S4_MP_DO", filters=1, kernel_sizes=1, pool_sizes=1, units=4, dropout_rates=4, activations=1)
    return Sequential([
        Input(shape=(m["features_num"],1), name="Input_1"),
        Reshape((m["features_num"],1,), name="Reshape_1"),
        Conv1D(m["filters"][0], kernel_size=(m["kernel_sizes"][0],), activation=m["activations"][0], name="Conv1D_1"),
